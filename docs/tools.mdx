...
| Tool                         | Description                                       |
| ---------------------------- | ------------------------------------------------- |
| `jenkins_list_jobs`          | List jobs/folders with full paths; opt in to recursion     |
| `jenkins_search_jobs`        | Search nested jobs by full name                   |
...
| `jenkins_create_job`         | Create a job from XML config, including in folders |
| `jenkins_update_job_config`  | Update an existing job's XML config               |
| `jenkins_rename_job`         | Rename a job                                      |
| `jenkins_copy_job`           | Copy a job within or across folders               |
